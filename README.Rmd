...
knitr::opts_knit$set(
  root.dir = "/Users/Shane/Work/CytoTalk/package-time"
)
```
...
Notice the first column has no header, this is fine. Without further ado, let's
run CytoTalk!
...
**2021-06-08: The latest release "CytoTalk_v3.1.0" is a major updated R version
on the basis of v3.0.3. We have added a function to generate Cytoscape files
for visualization of each ligand-receptor-associated pathway extracted from the
