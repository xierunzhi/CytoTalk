...
scores for each neighborhood in the "analysis" folder. This folder provides
extracted subnetworks, based on the "PCSF\_Network.txt" file. Additionally, the
"PathwayScores.txt" file contains a summary of the neighborhood size for each
pathway, along with empirical test values that are found by taking random
subnetworks from the "IntegratedNetwork.cfg" configuration file, which is used
as input to the PCSF algorithm. p-Values for node prizes (want to maximize) and
