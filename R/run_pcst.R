...
#' implementation of the PCST algorithm. You can view their repository
#' [here](https://github.com/fraenkel-lab/pcst_fast).
#'
...
#' @param omega_min Start point of the range `omega_min`-`omega_max`,
#' default 0.5.
#' @param omega_max Start point of the range `omega_min`-`omega_max`,
#' default 0.5. Could increase to 1.5.
#' @return None
#' @export
